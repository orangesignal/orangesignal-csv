...
/**
 * 指定された区切り文字形式データの値リストでフィルタする区切り文字形式データフィルタ群の論理和でフィルタを適用する区切り文字形式データフィルタの実装です。
 * 
 * @author 杉澤 浩二
 * @since 1.2.3
 */
public class CsvValueOrExpression extends CsvValueLogicalExpression {

	/**
	 * デフォルトコンストラクタです。
	 */
	public CsvValueOrExpression() {
		super();
	}
	 ...
	 */
	protected CsvValueOrExpression(final CsvValueFilter... filters) {
		super(filters);
	}
