...
/**
 * 指定された Java プログラム要素のフィールド値が空かどうかでフィルタを適用する Java プログラム要素フィルタの実装です。
 * 
 * @author 杉澤 浩二
 * @since 1.2.3
 */
public class BeanEmptyExpression extends BeanExpression {
	 ...
	 */
	protected BeanEmptyExpression(final String name) {
		super(name);
	}
