...
/**
 * 指定された項目位置に対応する区切り文字形式データの値が判定基準値以上かどうかでフィルタを適用する区切り文字形式データフィルタの実装です。
 * 
...
public class ColumnPositionGreaterThanOrEqualExpression extends ColumnPositionCriteriaExpression {
	 ...
	 */
	protected ColumnPositionGreaterThanOrEqualExpression(final int position, final String criteria) {
