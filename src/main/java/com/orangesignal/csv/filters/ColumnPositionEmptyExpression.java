...
/**
 * 指定された項目位置に対応する区切り文字形式データの値が空かどうかでフィルタを適用する区切り文字形式データフィルタの実装です。
 * 
 * @author 杉澤 浩二
 * @since 1.2.3
 */
public class ColumnPositionEmptyExpression extends ColumnPositionExpression {
	 ...
	 * @param position 項目位置
	 */
	protected ColumnPositionEmptyExpression(final int position) {
		super(position);
	}
