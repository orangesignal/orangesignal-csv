...
/**
 * 指定された Java プログラム要素のフィールド値が <code>null</code> でないかどうかでフィルタを適用する Java プログラム要素フィルタの実装です。
 * 
...
public class BeanNotNullExpression extends BeanExpression {
	 ...
	 */
	protected BeanNotNullExpression(final String name) {
		super(name);
	}

	@Override
	public boolean accept(final Object bean) throws IOException {
		return BeanExpressionUtils.isNotNull(bean, name);
	}
