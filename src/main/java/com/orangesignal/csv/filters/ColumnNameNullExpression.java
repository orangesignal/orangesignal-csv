...
/**
 * 指定された項目名に対応する区切り文字形式データの値が <code>null</code> であるかどうかでフィルタを適用する区切り文字形式データフィルタの実装です。
 * 
 * @author Koji Sugisawa
 * @since 1.2.3
 */
public class ColumnNameNullExpression extends ColumnNameExpression {
	 ...
	 */
	protected ColumnNameNullExpression(final String name) {
		super(name);
	}
