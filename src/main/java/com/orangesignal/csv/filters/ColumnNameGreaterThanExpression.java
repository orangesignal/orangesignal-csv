...
/**
 * 指定された項目名に対応する区切り文字形式データの値が判定基準値より大きいかどうかでフィルタを適用する区切り文字形式データフィルタの実装です。
 * 
...
public class ColumnNameGreaterThanExpression extends ColumnNameCriteriaExpression {
	 ...
	 */
	protected ColumnNameGreaterThanExpression(final String name, final String criteria) {
		super(name, criteria);
	}
