...
/**
 * 指定された Java プログラム要素のフィールド値が判定基準値群のいずれかと等しいかどうかでフィルタを適用する Java プログラム要素フィルタの実装です。
 * 
...
public class BeanInExpression extends BeanCriteriasExpression {
	 ...
	 */
	protected BeanInExpression(final String name, final Object... criterias) {
	 ...
	 * @throws IllegalArgumentException パラメータが <code>null</code> の場合
	 */
	protected BeanInExpression(final String name, final String... criterias) {
		super(name, criterias);
	}
	 ...
	 * @throws IllegalArgumentException パラメータが <code>null</code> の場合
	 */
	protected BeanInExpression(final String name, final String[] criterias, final boolean ignoreCase) {
