...
/**
 * 指定された区切り文字形式データの項目名リストと値リストでフィルタする区切り文字形式データフィルタ群の論理積でフィルタを適用する区切り文字形式データフィルタの実装です。
 * 
...
public class CsvNamedValueAndExpression extends CsvNamedValueLogicalExpression {
	 ...
	 */
	protected CsvNamedValueAndExpression(final CsvNamedValueFilter... filters) {
		super(filters);
	}
