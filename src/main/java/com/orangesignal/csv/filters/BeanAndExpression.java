...
/**
 * 指定された Java プログラム要素フィルタ群の論理積でフィルタを適用する Java プログラム要素フィルタの実装です。
 * 
 * @author Koji Sugisawa
 * @since 1.2.3
 */
public class BeanAndExpression extends BeanLogicalExpression {

	/**
	 * デフォルトコンストラクタです。
	 */
	public BeanAndExpression() {
		super();
	}
	 ...
	 */
	protected BeanAndExpression(final BeanFilter... filters) {
		super(filters);
	}
